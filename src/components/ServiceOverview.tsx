  ...
  const features = [
    {
      ...
      imagePath: '/images/ai-brainstorming.jpg',
    },
    {
      title: '事業計画を自動生成・改善',
      subtitle: 'し、形に落とし込む',
      ...
      imagePath: '/images/business-plan.jpg',
    },
    {
      title: '評価レポート',
      ...
      imagePath: '/images/evaluation-report.jpg',
    },
    {
      title: 'PDFやスライドに即出力',
      subtitle: 'し、社内外にすぐ共有',
      ...
      imagePath: '/images/export-documents.jpg',
    },
  ]
                ...
                <div className="relative aspect-video bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-gradient-blue via-gradient-purple to-gradient-green rounded-2xl opacity-20" />
                      <p className="text-gray-500">画像プレースホルダー</p>
                      <p className="text-gray-400 text-sm mt-1">{feature.imagePath}</p>
                    </div>
                  </div>
                </div>
              </div>
