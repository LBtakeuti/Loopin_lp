...
export default function HeroSection() {
  return (
    <AuroraBackground className="relative min-h-screen" showRadialGradient={false}>
      <div className="relative z-10 section-padding py-20 max-w-[1800px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center min-h-[70vh]">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-700 mb-3 md:mb-4 leading-relaxed max-w-xl px-4">
              小さな試行錯誤が積み重なり、やがて大きな成長を生む。
            </p>

            <p className="text-sm sm:text-base md:text-lg text-gray-600 mb-4 md:mb-6 leading-relaxed max-w-xl px-4">
              Loopinは、新規事業を推進するための"挑戦の循環"を支援するプラットフォームです。
            </p>

            <p className="text-sm sm:text-base text-gray-600 leading-relaxed max-w-xl px-4">
